...
class FmpAuthHeaderClass (object):
    ...
    _EFI_CERT_TYPE_RSA2048SHA256_GUID = uuid.UUID ('a7717414-c616-4977-9420-844712a735bf')
    ...
    def __init__ (self):
        ...
        self.CertType            = self._EFI_CERT_TYPE_RSA2048SHA256_GUID
        self.CertData            = b''
        self.Payload             = b''
    ...
    def Encode (self):
        ...
        if self.wCertificateType != self._WIN_CERT_TYPE_EFI_GUID:
            raise ValueError
        if self.CertType != self._EFI_CERT_TYPE_RSA2048SHA256_GUID:
            raise ValueError
    ...
    def Decode (self, Buffer):
        ...
        if wCertificateType != self._WIN_CERT_TYPE_EFI_GUID:
            raise ValueError
        if CertType != self._EFI_CERT_TYPE_RSA2048SHA256_GUID.bytes_le:
            raise ValueError
